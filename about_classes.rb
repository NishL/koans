...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    # ANSWER:
    # When a new object is instantiated, the initialize method
    # is called. This initialize method has a required argument,
    # when left out will result in ArgumentError.
  end
