...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # 
    # ANSWER:
    # `__send__` exists because some classes in Ruby define their own `send` method,
    # which have nothing to do with Object#send. Use `__send__` to be on the safe side,
    # and avoid overwriting the send methods in the class. `__send__` can be especially
    # useful in metaprogramming, when you need send to behave the way you expect it to.
  end
